...
import './App.css';
import Navigation from "./component/navba.js"
...
function App() {
  ...
  return (
    ...
    <div className="App">  
    <Navigation setSearch={setSearch} setSearchRate={setSearchRate} />
...
path="/movie"
render={() => (
  <Movielist movies={movies} search={search} searchRate={searchRate}  ></Movielist>
) }
/>
